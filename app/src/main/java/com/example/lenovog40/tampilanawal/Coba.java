...
public class Coba extends AppCompatActivity {
    ...
    public void cancelEffect(View view){
        try{
            ...
            checkUpdate();
            Toast.makeText(Coba.this, "Canceled", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void defaultEffect(View view){
        try{
            ...
            checkUpdate();
            Toast.makeText(Coba.this, "Default Images", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void gray(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Grayscale Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void binner(View view){
        try {
            ...
            Toast.makeText(Coba.this, "Binner Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void negative(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Negative Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void flip(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Flip Horizontal Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void flipvertical(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Flip Vertical Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void sharpen(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Sharpen Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void blur(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Blur Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void edge(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Edge Filter Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void identity(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Identity Filter Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void edgeenhance(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Edge Enhance Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void emboss(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Emboss Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
    ...
    public void gaussian(View view){
        try{
            ...
            Toast.makeText(Coba.this, "Gaussian Added Successfully", Toast.LENGTH_SHORT).show();
        }catch (Exception e){
        ...
        switch (item.getItemId()){
            ...
            case R.id.itemSaveImages:
                try{
                    ...
                    Toast.makeText(Coba.this, "Save Picture, Success", Toast.LENGTH_SHORT).show();
                }catch (Exception e){

                }

                break;
            case R.id.itemcompare:
                Intent iki = new Intent(this, Comparator.class);
                startActivity(iki);
                break;

            case R.id.itemkembali:
                Intent hh = new Intent(this, MainActivity.class);
                startActivity(hh);
                break;
